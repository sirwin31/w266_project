...
TRAIN_DATA = "train_data_27Nov_gc_roberta.pickle"
...
CHECKPOINT_FILE = "saved_model_epoch10_20201127_2032.tar"
...
def train():
    ...
    model = hft.RobertaForSequenceClassification.from_pretrained(
                MODEL_NAME)  
